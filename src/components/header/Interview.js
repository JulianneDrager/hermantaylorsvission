  ...
  return (
    <div className={interviewCon}>
      <img
        ...
        src="/assets/left-corner-background.png"
        alt="left corner background"
      />
      <div className={interviewSubCon}>
        <h1>
          <span className={goldWords}>LIFE'S CHAPTER</span>
          <br />
          HERMAN'S EXCLUSIVE INTERVIEW
        </h1>
        ...
        <footer className={footerDesktop}>
          COPY RIGHT @ {currentYear} DESIGNINGGLORY.COM{" "}
        </footer> */}
      </div>
      <img
        className={rightCorner}
        src="/assets/right-corner-background.png"
